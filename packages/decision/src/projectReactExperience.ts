...
/**
 * Projects Interpretation (+ graph/state context) into ReactExperienceModel.
 * Presentation only — does not derive Interpretation.
 */
export function projectReactExperience(
  registry: DecisionRegistry,
  state: DecisionState,
  interpretation: Interpretation,
  currentSceneId: string,
  house: HousePackage | null,
): ReactExperienceModel {
