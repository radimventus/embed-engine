...
export const clientStudioMountAliases: Record<string, string> = {
 ...
 */
export const workspaceSourceAliases: Record<string, string> = {
  "@embed-engine/runtime/priority/html-renderer": pkgSrc(
    "runtime",
    "priority/html-renderer/index.ts",
  ),
  "@embed-engine/runtime/priority/mock": pkgSrc(
    "runtime",
    "priority/mock/index.ts",
  ),
  "@embed-engine/runtime/priority-pipeline": pkgSrc(
    "runtime",
    "priority-pipeline.ts",
  ),
  ...
  "@embed-engine/object-house/builder-package/node": pkgSrc(
    "object-house",
    "builder-package/node.ts",
  ),
  "@embed-engine/object-house/builder-package": pkgSrc(
    "object-house",
  ...
  "@embed-engine/embed/partner-snippet": path.resolve(
    embedPackageRoot,
    "scripts/lib/partnerSnippet.mjs",
  ),
...
export function createSsotResolveAliases(): AliasOptions {
  const merged = {
