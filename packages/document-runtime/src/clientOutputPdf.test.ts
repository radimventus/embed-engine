...
const snapshot: ClientOutputSnapshot = { schemaVersion:1,capturedAt:'2026-09-14T08:00:00.000Z',company:{id:'c',name:'Partner'},project:{id:'p',name:'Projekt'},house:{id:'h',name:'Bungalov 4KK',storeys:1},knowledgeVersion:'v04',variant:'UNIVERSAL',priorities:['Energie'],exterior:[{id:'e',url:'bad.jpg',caption:'Exteriér ve vztahu k zahradě.'}],floorPlans:[{id:'f',url:'bad.jpg',caption:'Jednopodlažní dispozice.'}],interiors:[],priorityNarratives:[{title:'Energie',fact:'Doložený fakt.',userImpact:'Praktický dopad.'}],connectedTopics:[],blindspots:[],faq:[],plotAndProcess:['Ověřte orientaci na pozemku.'],auditConclusion:'Dům odpovídá vybraným prioritám.',cta:'Domluvte si další krok.'};
