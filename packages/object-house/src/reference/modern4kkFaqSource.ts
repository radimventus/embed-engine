...
export const MODERN_4KK_KNOWLEDGE: readonly HouseKnowledgeAtom[] = [
  {
    ...
    constraints: ['Není určen pro neomezenou individualizaci.'], relatedTopics: ['pozemek', 'flexibilita'],
  },
  {
    ...
    scope: 'PRODUCT', confidence: 'CONFIRMED', source: CURRENT_SOURCE, validFrom: '2026-08-07', temporalStatus: 'CURRENT',
    constraints: [], relatedTopics: ['dispozice', 'design'],
  },
  {
    ...
    scope: 'PRODUCT', confidence: 'CONFIRMED', source: CURRENT_SOURCE, validFrom: '2026-08-07', temporalStatus: 'CURRENT',
    constraints: ['Vhodnost orientace vždy závisí na konkrétní parcele.'], relatedTopics: ['pozemek', 'dispozice', 'soukromí'],
  },
  {
    ...
    scope: 'PRODUCT', confidence: 'CONFIRMED', source: CURRENT_SOURCE, validFrom: '2026-08-07', temporalStatus: 'CURRENT',
    constraints: ['Rozsáhlé změny dispozice mohou narušit původní optimalizaci.'], relatedTopics: ['flexibilita', 'konstrukce'],
  },
  {
    ...
    scope: 'PRODUCT', confidence: 'CONFIRMED', source: CURRENT_SOURCE, validFrom: '2026-08-07', temporalStatus: 'CURRENT',
    constraints: ['Není obytným druhým podlažím.'], relatedTopics: ['dispozice', 'údržba'],
  },
  {
    ...
    scope: 'PRODUCT', confidence: 'CONFIRMED', source: CURRENT_SOURCE, validFrom: '2026-08-07', temporalStatus: 'CURRENT',
    constraints: ['Detailní únosnosti a spojovací prostředky nejsou bez projektové dokumentace určeny pro poradenské tvrzení.'], relatedTopics: ['kvalita', 'akustika'],
  },
  {
    ...
    scope: 'PRODUCT', confidence: 'CONFIRMED', source: CURRENT_SOURCE, validFrom: '2026-08-07', temporalStatus: 'CURRENT',
    constraints: [], relatedTopics: ['konstrukce', 'údržba', 'energie'],
  },
  {
    ...
    scope: 'PRODUCT', confidence: 'CONFIRMED', source: CURRENT_SOURCE, validFrom: '2026-08-07', temporalStatus: 'CURRENT',
    constraints: [], relatedTopics: ['design', 'údržba'],
  },
  {
    ...
    scope: 'PRODUCT', confidence: 'CONFIRMED', source: CURRENT_SOURCE, validFrom: '2026-08-07', temporalStatus: 'CURRENT',
    constraints: ['Dům ani technologie nejsou bezúdržbové; vyžadují předepsané kontroly a servis.'], relatedTopics: ['údržba', 'provoz'],
  },
  {
    ...
    scope: 'PRODUCT', confidence: 'CONFIRMED', source: CURRENT_SOURCE, validFrom: '2026-08-07', temporalStatus: 'CURRENT',
    constraints: ['Číselné akustické parametry vyžadují měření nebo výpočet.'], relatedTopics: ['soukromí', 'akustika'],
  },
  {
    ...
    constraints: ['Není to garance konkrétní energetické nebo finanční úspory.'], relatedTopics: ['energie', 'provozní-náklady', 'investice'],
  },
  {
