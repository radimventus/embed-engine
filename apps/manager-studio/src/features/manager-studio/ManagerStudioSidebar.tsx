...
export function ManagerStudioSidebar() {
  ...
  return (
    ...
    >
      <div className="manager-section-navigation flex h-[52px] shrink-0 items-center px-6">
        <span className="text-[11px] font-bold uppercase tracking-[1px] text-[var(--platform-section)]">
          Manažerský přehled
        </span>
      </div>
      <ManagerWorkspaceScopeControls />
      <div className="manager-section-navigation flex flex-1 flex-col overflow-y-auto px-4 pb-6">
