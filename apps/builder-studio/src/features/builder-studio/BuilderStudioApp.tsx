...
export function BuilderStudioApp() {
  ...
  const [defaultHousesMessage, setDefaultHousesMessage] = useState<
    string | null
  >(null);
  ...
  return (
    <>
      ...
      >
        <AppShell
          ...
          workspacePanel={
            <WorkspaceSidebar
              ...
              onRecoverDefaultHouses={async () => {
                const result = await workspace.recoverDefaultHouses();
                  ...
                  <ProjectActionPanel
                    ...
                    onPublish={() => {
                      void publish().then((summary) => {
                        ...
                        recordLastPublish(`v${summary.housePackageVersion}`);
                        recordPlatformActivity({
                          label: "Publikace",
        ...
        >
          {workspace.switching && <PlatformLoading label="Přepínám projekt…" />}
          {!workspace.switching &&
            canonicalHouseContext !== null &&
            shouldShowCanonicalHouseEmptyState(
              canonicalHouseContext,
          ...
          {!workspace.switching && activeHouseHasNoPackage && (
            <PlatformEmptyState
              icon="⌂"
