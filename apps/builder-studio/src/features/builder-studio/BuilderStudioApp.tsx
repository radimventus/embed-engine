  ...
  return (
    ...
    >
      <WorkspaceCanvas
        ...
        exportCompatibilityPackage={session.exportCompatibilityPackage}
        ...
        objectMetadataPackage={session.objectMetadataPackage}
        objectMetadataDocument={session.objectMetadataDocument}
        ...
        onCreateObjectMetadata={session.createObjectMetadata}
        onUpdateObjectMetadataGeneral={session.updateObjectMetadataGeneral}
        onUpdateObjectMetadataSeo={session.updateObjectMetadataSeo}
        onAttachObjectMetadataAsset={session.attachObjectMetadataAsset}
        onDetachObjectMetadataAsset={session.detachObjectMetadataAsset}
        onOpenObjectMetadataAsset={session.openObjectMetadataAsset}
        onAddObjectMetadataAttribute={session.addObjectMetadataAttribute}
        onEditObjectMetadataAttribute={session.editObjectMetadataAttribute}
        onRemoveObjectMetadataAttribute={session.removeObjectMetadataAttribute}
