...
export const OFFER_PACKAGES: readonly OfferPackage[] = Object.freeze([
  {
    ...
    recommended: false,
    highlights: ['1 dům', 'Client · Manager · Sales', 'Základní branding'],
  },
  {
    id: 'starter',
    name: 'Starter',
    ...
    recommended: true,
    highlights: ['Až 3 domy', 'Client · Manager · Sales', 'Plný brand'],
  },
  {
    id: 'studio-partner',
    name: 'Studio Partner',
    ...
    recommended: false,
    highlights: ['Neomezeně (MVP)', 'Client · Manager · Sales', 'Brand + hero'],
  },
]);
