...
/**
 * PT-002 — Recommended section order from Decision Story.
 * Pure projection of ExperienceProjection.recommendedSectionOrder.
 */
export function RecommendedSectionOrder() {
  const { story, recommendedSectionOrder } = useExperienceProjection();

  return (
    <section
      aria-label="Doporučené pořadí sekcí"
    ...
    >
      ...
      <p className="mt-1 text-xs text-embed-foreground-primary/55">
        Pořadí následujících sekcí podle Decision Story
      </p>
