...
export function RoomIndex() {
  return (
    <section
      ...
      className="relative z-20 grid h-full min-w-0 shrink-0 grid-rows-[auto_1fr_100px] content-start items-start gap-0 overflow-x-hidden pl-section pr-0 pb-section"
    >
      ...
      <div className={`flex ${SPATIAL_TERMINAL_THUMBNAIL_ROW_CLASS} flex-col justify-end`}>
        <div
          className={`${SEGMENTED_CONTROL_FLOOR_BASELINE_CLASS} ${HOUSE_NAVIGATOR_ROOM_CONTROL_WIDTH_CLASS} z-20`}
        >
          <MediaModeToggle />
        </div>
      </div>
