        ...
        <div className="sales-desk__canvas">
          <div className="sales-desk__grid">
            ...
            >
              ...
              />
                <label className="sales-desk__client-select-wrap">
                  <span className="sales-desk__scope-label">Klient</span>
                  <select
                    className="sales-desk__client-select"
                  ...
                  >
                    {visibleClients.length === 0 ? (
                      <option value="">Žádní klienti</option>
                    ) : null}
