# CONIS Core Documentation (SSOT)

Autorativní projektové dokumenty (PT-SSOT-01).

| Dokument | Soubor | Účel |
| --- | --- | --- |
| CONIS PROJECT BRIEF | [CONIS PROJECT BRIEF.docx](./CONIS%20PROJECT%20BRIEF.docx) | 10–15 min přehled projektu |
| PLATFORM ROADMAP | [PLATFORM ROADMAP.docx](./PLATFORM%20ROADMAP.docx) | Aktuální stav implementace |
...
Baseline referencí: Office Studio v1.0 @ `1f5a873`, OFFICE ROADMAP v2.0, Commercial Journey v1.0 inventory · Platform Data Constitution v1.0 (PDM-01).
