...
Platform theory (not a schema): [PT-001](../architecture/pt/PT-001-house-package-canonical-object-contract.md) · [PT-002 — Interpretation is the Product](../architecture/pt/PT-002-interpretation-is-the-product.md)
